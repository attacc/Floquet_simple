...
dir_gap=minimum(TB_sol.eigenval[2,:]-TB_sol.eigenval[1,:])*ha2ev
# 
# Dipoles
#
...
D_exciton, f_osc = Build_Exciton_Dipoles(Dip_h, exciton_wavefunctions, k_grid, lattice)


# 4. Compute \varepsilon_2(\omega) along x-polarization [1, 0]

eps_2_bse = Build_Dielectric_Function(
    D_exciton,
    exciton_energies,
    freqs,
    lattice,
